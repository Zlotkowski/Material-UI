    ...
    return (
        <Grid container direction="column" className={classes.mainContainer}>
                        ...
                        <Grid container justifyContent="center" className={classes.buttonContainer}>
                            <Grid item>
                                <Button component={Link} to="/estimate" variant="contained"
                                        className={classes.estimateButton} onClick={() => setNumTab(5)}>Free
                                    Estimate</Button>
                            </Grid>
                            <Grid item>
                                <Button component={Link} to="/revolution" variant="outlined"
                                        className={classes.learnButtonHero} onClick={() => setNumTab(2)}>
            ...
            <Grid item> {/*-----Custom Software Block-----*/}
                <Grid container direction={"row"} justifyContent={matchesSM ? "center" : undefined}
                    ...
                    <Grid item style={{marginLeft: matchesSM ? 0 : "5em", textAlign: matchesSM ? "center" : undefined}}>
                        ...
                        <Button component={Link} to="/customsoftware" variant="outlined"
                                className={classes.learnButton} onClick={() => {
                            setNumTab(1);
                            setSelectedIndex(1)
                        }}>
                            <span style={{marginRight: 10}}>Learn More</span>
            ...
            <Grid item> {/*-----iOS/Android App Development-----*/}
            ...
            <Grid item> {/*-----Wbsite Development-----*/}
                <Grid container direction={"row"} justifyContent={matchesSM ? "center" : undefined}
                    ...
                    <Grid item>
                        <img className={classes.icon} src={webSitesIcon} alt="websites software icon"/>
                    </Grid>
                </Grid>
            </Grid>
                            ...
                            <Grid container style={{marginBottom: matchesXS ? "10em" : 0}} direction="column">
                                ...
                                <Grid item>
                                    <Button component={Link} to="/about" variant="outlined"
                                            ...
                                            className={classes.learnButton} onClick={() => setNumTab(3)}>
                                        <span style={{marginRight: 10}}>Learn More</span>
                            ...
                            <Grid container direction="column">
                                ...
                                <Grid item>
                                    <Button component={Link} to="/contact" variant="outlined"
                                            style={{color: "white", borderColor: "white"}}
                                            className={classes.learnButton} onClick={() => setNumTab(4)}>
                                        <span style={{marginRight: 10}}>Learn More</span>
                                        <ButtonArrow width={10} height={10} fill="white"/>
                                    </Button>
                                </Grid>
