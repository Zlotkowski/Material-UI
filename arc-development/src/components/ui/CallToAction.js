...
function CallToAction(props) {
    ...
    const {setNumTab} = props;

    return <Grid container alignItems="center" justifyContent={matchesSM ? "center" : "space-between"}
            ...
            <Grid container direction="column">
                <Grid item>
                    ...
                    <Grid container justifyContent={matchesSM ? "center" : undefined} item>
                        <Button component={Link} to="/estimate" variant="outlined" className={classes.learnButton}
                                onClick={() => setNumTab(2)}>
