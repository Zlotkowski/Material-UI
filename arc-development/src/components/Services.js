        ...
        <Grid container direction="column">
            ...
            <Grid item> {/*-----iOS/Android App Development-----*/}
                <Grid container direction={"row"} justifyContent={matchesSM ? "center" : "flex-end"}
                      className={classes.serviceContainer} style={{marginTop: matchesSM ? "1em" : "5em"}}>
                    <Grid item
                    ...
                    <Grid item style={{marginRight: matchesSM ? 0 : "5em",}}>
                        <img className={classes.icon} src={mobileAppsIcon} alt="mobile app icon" width="250em"/>
                    </Grid>
                </Grid>
            </Grid>
            ...
            <Grid item> {/*-----Wbsite Development-----*/}
                <Grid container direction={"row"} justifyContent={matchesSM ? "center" : "flex-end"}
                      className={classes.serviceContainer} style={{marginBottom: "10em"}}>
                    <Grid item
                          style={{textAlign: matchesSM ? "center" : undefined, width: matchesSM ? undefined : "35em"}}>
                        <Typography variant="h4">
                            Website Development
                    ...
                    <Grid item style={{marginRight: matchesSM ? 0 : "5em"}}>
                        <img className={classes.icon} src={webSitesIcon} alt="websites software icon" width="250em"/>
                    </Grid>
                </Grid>
            </Grid>
        </Grid>
